...
This is a data analysis project based on an assumption that Microsoft Company wants to venture into movie production
hence they need some insights on what type of films to create.
